  ...
  return (
    <div className="about-container">
      ...
      <ul className="about-list">
        ...
        <li className="about-list-item">Vivamus maximus nisi et nunc maximus</li>
      </ul>
      <p className="about-paragraph">
        Nulla facilisi. Integer nec nisi nec felis tincidunt tempus vel sit
        amet urna. Donec molestie augue nec nisi efficitur, nec suscipit neque
